...
class AddScrapBottomSheet extends ConsumerStatefulWidget {
  const AddScrapBottomSheet({super.key});

  @override
  ConsumerState<AddScrapBottomSheet> createState() =>
      _AddScrapBottomSheetState();
}

class _AddScrapBottomSheetState extends ConsumerState<AddScrapBottomSheet> {
  ...
  Future<void> addScrap() async {
    ...
    try {
      ...
      final response = await ApiService.addScrap(
        userId!,
            ...
            children: [
              ...
              TextFormField(
                ...
                onTap: () async {
                  ...
                  if (pickedDate != null) {
                    ...
                    setState(() {
                      _scrapDateController.text = formattedDate;
                    });
                  }
                },
                validator: (value) {
              ...
              ElevatedButton(
                onPressed: _isLoading
                    ? null
                    : () {
                        if (_formKey.currentState!.validate()) addScrap();
                      },
                child: _isLoading
                    ? SizedBox(
                        height: 24,
